...
public class CompressUtil {
	 ...
	 *             压缩文件有损坏或者解压缩失败抛出
	 */
	public static File[] unzip(String zip, String dest, String passwd ,String taskid)
			throws ZipException {
		File zipFile = new File(zip);
		return unzip(zipFile, dest, passwd, taskid);
	}
	 ...
	 *             压缩文件有损坏或者解压缩失败抛出
	 */
	public static File[] unzip(String zip, String passwd,String taskid) throws ZipException {
		File zipFile = new File(zip);
		File parentDir = zipFile.getParentFile();
		return unzip(zipFile, parentDir.getAbsolutePath(), passwd, taskid);
	}
	 ...
	 *             压缩文件有损坏或者解压缩失败抛出
	 */
	public static File[] unzip(File zipFile, String dest, String passwd,String taskid)
			throws ZipException {
		ZipFile zFile = new ZipFile(zipFile);
		ProgressMonitor Progress=zFile.getProgressMonitor();
		CompressProgressMonitorListener pbt = new CompressProgressMonitorListener(Progress,taskid);
	...
	public static void main(String[] args) {
		//zip("F:\\01内部项目存储区\\11保密区\\02项目\\16_数据管理小组\\云盒效果图","F:\\01内部项目存储区\\11保密区\\02项目\\16_数据管理小组\\云盒效果图.zip", "11");
		try {
			File[] files = unzip("F:\\01内部项目存储区\\11保密区\\02项目\\16_数据管理小组\\11.zip", "aa","0");
