/**
 * 
 * @authors gongzk (gongzk@rsclouds.com)
 * @date    2015-04-16 11:20:25
 * @version 1.0
 */
...
OpenLayers.Popup.CSSFramedCloud = OpenLayers.Class(OpenLayers.Popup.Framed, {
  ...
  positionBlocks: {
        "tl": {
            'offset': new OpenLayers.Pixel(44, -6), // 整体相对于参考位置的偏移
            'padding': new OpenLayers.Bounds(5, 14, 5, 5),
            'blocks': [
                { 
                    className: 'olwidgetPopupStemTL',
                    size: new OpenLayers.Size(20, 20),
                    anchor: new OpenLayers.Bounds(null, 4, 32, null),   // 相对于参考位置的偏移
