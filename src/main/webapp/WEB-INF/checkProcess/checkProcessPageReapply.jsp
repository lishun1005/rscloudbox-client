		...
		<div class="mainWrap mar-auto">
			...
			<div class="sell contentWrap ">
				<form id="sellForm" class="sellForm content mar-auto" action="/addCheckProcess" method="post" enctype="multipart/form-data">
					<input type="hidden"  name="downloadDataListIds" value="${downloadDataListIds}">
					<div class="name">客户名称：<input type="text" value="${customerName}" autocomplete="off" maxlength="50" name="customer_name" onkeyup="$('.demoForm input[name=customer_name]').val(this.value)"/><span class="must red font14">*必填</span></div>
					<span class="error"></span>
					<div class="customName">客户联系人：<input type="text" value="${customerContacter} " autocomplete="off" maxlength="20" name="customer_contacter" onkeyup="$('.demoForm input[name=customer_contacter]').val(this.value)"/><span class="must red font14">*必填</span></div>
					<span class="error"></span>
					<div class="customTel">客户联系方式：<input type="text" value="${customerContact}" autocomplete="off" name="customer_contact" onkeyup="$('.demoForm input[name=customer_contact]').val(this.value)"/><input type="hidden" autocomplete="off" name="backUrl" /><span class="must red font14">*必填</span></div>
					<span class="error"></span>
			...
			<div class="demo contentWrap dn">
				<form id="demoForm" class="demoForm content mar-auto" enctype="multipart/form-data" role="form" action="/addCheckProcess" method="post">
 					<input type="hidden"  name="downloadDataListIds" value="${downloadDataListIds}">
 					<div class="name">客户名称：<input type="text" class="customer_name" value="${customerName}" autocomplete="off" maxlength="50" name="customer_name" /><span class="must red font14">*必填</span></div>
					<span class="error"></span>
					<div class="customName">客户联系人：<input type="text" autocomplete="off" value="${customerContacter}" maxlength="20" name="customer_contacter" /><span class="must red font14">*必填</span></div>
					<span class="error"></span>
					<div class="customTel">客户联系方式：<input type="text" autocomplete="off" value="${customerContact}" name="customer_contact" /><input type="hidden" autocomplete="off" name="backUrl" /><span class="must red font14">*必填</span></div>
					<span class="error"></span>
